...
- Preview: https://main--StoreFrontDemo--ankita-radadiya.hlx.page/
- Live: https://main--StoreFrontDemo--ankita-radadiya.hlx.live/
...
1. Open the `StoreFrontDemo` directory in your favorite IDE and start coding :)
